...
6. **Setup Instructions:** Always keep the `SETUP.md` file up-to-date with any new dependencies, environment variables, or migration steps necessary to run the project. Refer to this file when configuring the project on a new device.