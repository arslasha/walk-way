...
## Acceptance Criteria
- [x] API service/functions created in Next.js to fetch places, categories, and tags from the Django backend.
- [x] Search interface updated to allow selecting categories and tags.
- [x] (Optional) Geolocation API used in the browser to pass user coordinates to the backend for radius search.
- [x] The feed dynamically updates based on the selected filters.
