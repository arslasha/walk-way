      ...
      <div className="flex flex-col gap-6 md:flex-row md:items-start md:gap-12">
        ...
        <div className="relative hidden md:flex md:w-[42%] md:items-start md:justify-end">
          <div className="relative h-72 w-full max-w-sm">
            <div className="absolute right-0 top-8 h-44 w-36 rotate-3 rounded-2xl bg-foreground/10 shadow-xl" />
            <div className="absolute right-8 top-0 h-52 w-40 -rotate-2 overflow-hidden rounded-2xl bg-foreground/8 shadow-2xl">
            ...
            <div className="absolute right-4 top-16 h-44 w-36 rotate-1 overflow-hidden rounded-2xl bg-foreground/5 shadow-xl">
